  ...
  return (
    <div className="w-full h-fit flex flex-col gap-4 p-6 bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-xl shadow-sm">
      ...
      <button
        ...
        className="relative w-full mt-2 py-3 px-4 overflow-hidden bg-gradient-to-r from-cyan-600 to-cyan-700 
    ...
    -translate-x-full animate-shimmer"
        ...
        <span className="absolute inset-0 bg-gradient-to-b from-white/5 to-transparent pointer-events-none"></span>
      </button>
    </div>
  );
};
